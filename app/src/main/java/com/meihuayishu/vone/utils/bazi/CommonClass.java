...
public class CommonClass {
     ...
     * @param
     */
    public static String taohua(String[] bazi) {
    ...
    /**
     * 所谓命主文昌位，就是根据个人的生辰八字来推算，按照这个方法推算出来的文昌位是跟随个人，永不改变的。
     * 个人的命主文昌位如何确定?有这样一个推算的歌诀：
     * 甲岁亥巳曲与昌，乙逢马鼠焕文章，丙戊申寅庚亥巳，六丁鸡兔贵非常，壬遇虎猴癸兔西，辛宜子上马名扬。
     * 歌诀的意思是：
     * 出生在甲年的人，文昌位在东南。
     * 出生在乙年，文昌位在正南。
     * 出生在丙年，文昌位在西南。
     ...
     * 出生在壬年，文昌位在东北。
     * 出生在癸年，文昌位在正东。
     * 人又是如何得知自己出生在那年？这里有一套公式可以推算：
     * 凡尾数是4的年份，如2004年，即是甲年。
     * 以此类推，尾数是5的年份，即是乙年。
     * 尾数是6的年份，即是丙年。
     * 尾数是7的年份，即是丁年。
     * 尾数是8的年份，即是戊年。
     ...
     * 尾数是3的年份，即是癸年。
     * 例如1013年，即是癸年。
     * 以自己的出生年份对应上面两个公式来推算，即可知道自己的命主文昌位在哪个位置。
     *
     * @param year 年份
     * @return 文昌位:
     */
