...
public class ShenShaHehun {
    ...
    public static final String[][] numsix = {
            //干支，纳音，岁数，男，女
            {"丙戌", "屋上土", "1", "3", "3"},
            {"乙酉", "泉中水", "2", "4", "2"},
            {"甲申", "泉中水", "3", "5", "1"},
            ...
            {"戊子", "霹雳火", "59", "7", "8"},
            {"丁亥", "屋上土", "60", "8", "7"},};
    public static final String[][] shensha1 = {
    ...
    public static final String[][] shensha2 = {
     ...
     * @return 返回纳音
     */
    public static String getnumsix(String year) {
    ...
    public String shensha(Calendar cal) throws ParseException {
        ...
        for (int i = 0; i < 14; i++) {
            if (month.equalsIgnoreCase(shensha1[number][i])) {
                result.append("犯" + shensha1[0][i]);
                result.append("\n");
            }
            if (month.equalsIgnoreCase(shensha2[number][
                    i])) {
                result.append("犯" + shensha2[0][i]);
                result.append("\n");
            }
        }
    ...
    public static void main(String[] args) {
        ShenShaHehun my = new ShenShaHehun();
        try {
            System.out.println(my.hehun("1993-9-16 18", "1993-9-16 19"));
        } catch (Exception e) {
            e.printStackTrace();
        }
    }
